...
import { anonymous, productsImg01, productsImg02, productsImg03, productsImg04 } from '../../asserts/images';
                    ...
                    <Col md={6}>
                        <div>
                            ...
                            <div className="d-flex align-items-center justify-content-center gap-3">
                                <h2 className="primaryHeading">the best <span className='productsBluefont'>Products</span></h2>
                            </div>
                        </div>
                    </Col>
                    ...
                    <Col md={6}>
                        <div>
                            ...
                            <p class="welcome_para m-0">
                                ...
                                idunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exe
                ...
                <Row className='pt-5 position-relative'>
                    ...
                    <Col md={3}>
                        <div className='main_product_card'>
                            ...
                            <p className='product_card_heading text-center'>Roller Shades</p>
